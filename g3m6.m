...
%% 1-The original signal x(t) for -5 < t < 5 
% Define time range 
SamplingFreq = 16000; 
...
%% 2-The Time-Shifted signal shifted(t)
% shifted= x(t - 0.2 * s)
...
%% 3- The Time-Scaled signal scaled_sig(t)
...
%% 4-The Amplitude-Scaled signal scaled_Amp_sig(t)
...
%% 5-The filter system filter_sys(t)
...
%% 6-The magnitude spectrum of the input signal: |input_signal(w)|
...
%% 7-The magnitude spectrum of the input signal: |input_Amp_sig(w)|
...
%% 8-The magnitude spectrum of the filtering system: |filter_sys(w)|
...
%% 9-The magnitude spectrum of the output signal |output_signal(w)|
...
%% 10-The time-domain output signal output_time(t)
